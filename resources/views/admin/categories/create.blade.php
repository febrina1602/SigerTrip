...
@section('title', 'Tambah Kategori - SigerTrip')
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                {{-- Upload Icon --}}
                                <div class="mb-4">
                                    <label for="icon" class="form-label fw-semibold">Icon Kategori</label>
                                    <input type="file" 
                                    ...
                                    <small class="text-muted">Format: JPG, PNG, SVG (Maksimal 2MB). Opsional.</small>
                                    @error('icon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
