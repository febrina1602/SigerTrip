...
<head>
    ...
    <style>
        ...
        {{-- NEW: Styling untuk komponen header app --}}
        .app-navbar { background-color: white; border-bottom: 1px solid #dee2e6; }
        .app-nav-link { padding: 12px 8px; color: #333; text-decoration: none; font-weight: 600; border-bottom: 2px solid transparent; transition: all 0.3s ease; display: inline-block; }
        .app-nav-link:hover { color: #dc3545; }
        .app-nav-link.active { color: #dc3545; border-bottom-color: #dc3545; }
